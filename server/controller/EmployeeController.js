...
<tr>
    <td style="padding: 0;">
        <table role="presentation" style="max-width: 600px; margin: 0 auto; background-color: #ffffff; padding: 0; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
            ...
            <tr>
                <td style="padding: 40px 30px;">
                    ...
                    <p style="color: #333333; font-size: 16px; margin-bottom: 20px;">
                        It is with great pleasure that we welcome you to Our [CompanyName]! We are excited to have you join us and are confident that your skills and expertise will play a significant role in our ongoing success. Your contributions will strengthen our team and help us achieve our shared goals.
                    </p>
                    ...
                    <p style="color: #333333; font-size: 16px; margin-bottom: 20px;">
                        ...
                        <a href="mailto:shaloomjames.dev@gmail.com" style="color: #003366; text-decoration: none;">shaloomjames.dev@gmail.com</a>.
                    </p>
                    <p style="color: #333333; font-size: 16px; margin-bottom: 20px;">
            ...
            <tr>
                <td style="background-color: #f0f4f8; padding: 30px; text-align: center;">
                    ...
                    <p style="color: #666666; font-size: 12px; margin-top: 20px;">© 2024 Shaloom James. All rights reserved.</p>
                </td>
            </tr>
        </table>
    </td>
      ...
      await SendMail(
        ...
        `Hi ${employeeName}, welcome to our [CompanyName] Family!`,
        emailHTML
      );
    } catch (err) {
